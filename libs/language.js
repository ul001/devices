...
function getZhLanguage() {
  Operation = {
    ...
    ui_AlarmDealPer: "报警处理率",
    ui_AlarmAnalysisSum: "告警数目",
    ui_AlarmAnalysisCount: "报警次数",
    ui_AlarmAnalysisType: "报警类型",
    ui_AlarmDealPositive: "报警处理率正序",
    ui_AlarmDealReverse: "报警处理率反序",
    ui_AlarmAnalysisPositive: "报警数正序",
    ui_AlarmAnalysisReverse: "报警数反序",
    ui_AlarmUnused: "未使用",
    ui_AlarmUsed: "使用",
    ui_AlarmDebug: "调试",
    ui_AlarmTest: "检测",
    ...
    ui_closeTaskTip: "确定要关闭工单吗？",
    ui_closeTaskTip1: "关闭工单后，工单无法继续被执行，确定关闭吗？",
    ui_endTaskTip: "确定要结束任务吗？",
    ...
    ui_operateAllTipOf30: "控制指令发送时间间隔为30秒，请勿频繁操作！",
    ...
    ui_charger: "负责人",
    ui_worker: "执行人",
    ui_organizations: "组织机构",
    ui_organizations1: "组织机构:",
    ui_selectorganizations: "请输入组织机构名进行搜索",
    ...
    ui_orderStarttime: "工单开始时间",
    ui_orderEndtime: "工单结束时间",
    ui_Limitedsingleload2: "限定抢单负荷",
    ui_Limitedsingleload3: "抢单负荷:",
    ui_executeStarttime: "开始时间:",
    ui_executeEndtime: "结束时间:",
    //code码
    code_200: "请求成功，插入成功",
    code_201: "主外键异常",
    ...
    code_372: "用户没有所选变电所的权限，请到用户管理页面配置",
    ...
    code_383: "队列服务器连接超时，请检查队列服务器配置是否正确",
    code_384: "队列创建失败，请检查使用的队列服务器账户是都具有足够的操作权限",
    code_385: "业务队列不存在，请检查对应业务字段是否正确",
    code_386: "版本号已存在",
    code_387: "参数不存在",
    code_388: "激活码已过期，无法更新",
    code_389: "当前报警分类下，已存在报警类型，不可删除该报警分类",
    code_390: "无效订阅",
    code_391: "报警类型模板无法删除",
    code_392: "托管已到期，请联系管理员",
    code_393: "参数值不符合规范",
    code_394: "必要参数缺失",
    code_395: "工作通知不可更改分类",
    code_396: "该用户所属的组织机构已过期，请到组织机构管理中更新使用时间",
    code_397: "第三方的applicationKey不能为空",
    code_398: "未填写正确的第三方数据",
    code_399: "第三方域名不能为空",
    code_400: "第三方账号不能为空",
    code_403: "文件重名",
    code_402: "重命名失败",
    code_405: "旧密码错误",
    code_406: "新密码不能与旧密码相同",
    code_407: "新密码不能为空",
    code_408: "抱歉，该任务已被别人抢先了",
    code_409: "抢单失败",
    code_410: "获取配置信息失败",
    code_411: "该ip无法访问，不能配置",
    code_412: "该参数或参数名已经存在",
    code_413: "乐橙云信息更新失败",
    code_414: "缺少二级密码",
    code_415: "二级密码不正确",
    code_416: "用户未配置二级密码",
    ...
    code_418: "没有可改变的回路",
    code_419: "车盒子账号添加失败",
    code_420: "请现在组织机构配置车盒子管理员账号",
    code_421: "车盒子imei输入有误/车盒子账号信息有误",
    code_422: "查询车盒子定位失败",
    code_423: "上层组织机构已添加车盒子账号，不能在下层再次添加",
    code_424: "车盒子Imei号不能重复添加",
    code_425: "当前车盒子账号权限不足，请联系卖方咨询修改",
    code_426: "未配置乐橙云appId与secret信息",
    code_427: "文件格式不支持",
    code_428: "访客已存在",
    code_429: "访客登记失败，该用户是系统用户，请直接登录系统，无需访客注册",
    code_430: "手机号非法，请输入正确的手机号",
    code_431: "新增失败，该变电所下已存在同名点位",
    code_432: "修改失败，变电所下已存在同名点位",
    code_433: "点位关系绑定失败",
    code_434: "暂无该应用权限，请联系管理员开通",
    code_435: "仪表厂商同名编号已存在",
    code_436: "同一厂商下产品类别已存在",
    code_437: "平台访客验证码获取次数超限",
    code_438: "该变电所仪表已绑定过其他设备，请确保数据正常",
    code_439: "该计算项未初始化排序值",
    code_440: "没有可改变的计算项",
    code_441: "该文档分类下有文件，无法删除",
    code_442: "未获取到法定节假日配置，请自定义配置",
    code_443: "命令未能发送成功，请确保网关接收程序正常运行",
    code_444: "请选择组织机构",
    code_445: "该设备已绑定二维码",
    code_446: "非平台二维码",
    code_447: "未绑定的平台二维码",
    code_448: "二维码已被其它设备绑定",
    code_449: "接口调用超出限制，请稍后再试",
    code_450: "密码不符合规范，必须包含大小写字母，数字及特殊符号",
    code_451: "密码错误次数过多，请稍后再试",
    code_452: "用户或密码输入错误",
...
function getEnLanguage() {
  Operation = {
    ...
    ui_showalldevice1: "Show All Device",
    ...
    ui_dissuccess: "Disable success！",
    ui_disFail: "Disable Fail!",
    ...
    ui_SubVideo: "Substation Video:",
    ui_Originator: "Originator:",
    ui_Originator1: "Originator",
    ...
    //报警
    ui_Alarm: "Alarm",
    ui_AlarmDealPer: "Alarm Rate",
    ui_AlarmAnalysisSum: "Alarms Sum",
    ui_AlarmAnalysisCount: "Alarms Count",
    ui_AlarmAnalysisType: "Alarms Type",
    ui_AlarmAnalysis: "AlarmAnalysis",
    ui_AlarmAnalysisManager: "AnalysisManager",
    ui_AlarmDealPositive: "DealPositive",
    ui_AlarmDealReverse: "DealReverse",
    ui_AlarmAnalysisPositive: "CountPositive",
    ui_AlarmAnalysisReverse: "CountReverse",
    ui_AlarmUnused: "Unused",
    ui_AlarmUsed: "Used",
    ui_AlarmDebug: "Debug",
    ui_AlarmTest: "Test",
    ...
    ui_saveedWantOut: "Are you sure you want to exit?",
    ui_noSaveWantDelete: "Are you sure you want to delete the saved defect?",
    ...
    ui_suredis: "Are you sure to disable the device",
    ui_question: "?",
    ...
    ui_closeOrder: "Close Order",
    ui_closeOrderSuccess: "Close Order Success",
    ui_endOrder: "Finish Order",
    ...
    ui_closeTaskTip: "Are you sure to close the task?",
    ui_closeTaskTip1: "Are you sure to close the task?",
    ui_endTaskTip: "Are you sure to submit and close the task?",
    ...
    ui_uploadPicTip: "Upload up to three pictures!",
    ...
    ui_silent: "Silence",
    ui_HeZha: "Close",
    ui_fixedTime: "TimeTask",
    ui_fixedTimeTask: "TimeTaskParameters",
    ui_check: "Check",
    ui_control: "Control",
    ui_record: "Record",
    ui_normal: "normal",
    ...
    ui_operateAllTipOf30: "The control command sending interval is 30 seconds, please do not operate frequently!",
    ...
    ui_selectTerminalGroup: "Please enter a terminal group name to search",
    ui_organizations: "Organization",
    ui_organizations1: "Organization:",
    ui_selectorganizations: "Please enter the organization name to search",
    ...
    ui_noticeBill: "NoticeWork",
    ui_mynoticeBill: "MyWork",
    //任务列表筛选
    ...
    ui_RobNotificContent: "Notification Content：",
    ui_Blackoutnotification: "BlackoutNotification",
    ui_notificationContent: "notificationContent",
    ui_notificationContentTip: "Please enter the notification content",
    ui_pleaseInputNum: "Please enter the number",
    ui_pleaseInputTitle: "Please enter the title",
    ui_Limitednumber: "Limited number",
    ...
    ui_Limitedsingleload2: "Limited single load",
    ui_Limitedsingleload3: "Limited single load:",
    ui_executeStarttime: "ExecuteStarttime:",
    ui_executeEndtime: "ExecuteEndtime:",
    //code码
    ...
    code_383: "The queue server connection timed out, please check if the queue server configuration is correct",
    code_384: "Queue creation failed, please check that the queue server account used has sufficient operation rights",
    code_385: "Business queue does not exist, please check whether the corresponding business field is correct",
    code_386: "Version number already exists",
    code_387: "Parameter does not exist",
    code_388: "The activation code has expired and cannot be updated",
    code_389: "Under the current alarm classification, the alarm type already exists, and the alarm classification cannot be deleted",
    code_390: "Invalid subscription",
    code_391: "Alarm type template cannot be deleted",
    code_392: "Hosting has expired, please contact the administrator",
    code_393: "Parameter value does not meet specifications",
    code_394: "Required parameters are missing",
    code_395: "Work notifications cannot be changed",
    code_396: "The organization to which the user belongs has expired, please go to the organization management to update the usage time",
    code_397: "Third party applicationkey cannot be empty",
    code_398: "Incorrect third party data not filled in",
    code_399: "Third party domain name cannot be empty",
    code_400: "Third party domain name cannot be empty",
    code_403: "Duplicate file name",
    code_402: "Rename failed",
    code_405: "Old password error",
    code_406: "The new password cannot be the same as the old password",
    code_407: "New password cannot be empty",
    code_408: "Sorry, this task has been preempted by others",
    code_409: "Failed to snatch the order",
    code_410: "failed to obtain configuration information,",
    code_411: "the IP cannot be accessed and cannot be configured,",
    code_412: "the parameter or parameter name already exists,",
    code_413: "lechengyun information update failed,",
    code_414: "missing secondary password,",
    code_415: "level 2 password is incorrect,",
    code_416: "the user has not configured the secondary password,",
    code_417: "the sorting value of this circuit is not initialized,",
    code_418: "there is no changeable loop.",
    code_419: "failed to add car box account,",
    code_420: "please configure the car box administrator account for the organization now.",
    code_421: "wrong input of IMEI in car box / wrong account information in car box,",
    code_422: "failed to query the car box location,",
    code_423: "the car box account number has been added to the upper level organization. It cannot be added again in the lower level.",
    code_424: "the IMEI number of the car box cannot be added repeatedly.",
    code_425: "the authority of the current car box account is insufficient, please contact the seller for modification.",
    code_426: "no configuration of Lecheng cloud appid and secret information,",
    code_427: "file format not supported,",
    code_428: "the visitor already exists",
    code_429: "visitor registration failed. The user is a system user. Please log in to the system directly without visitor registration.",
    code_430: "the mobile phone number is illegal, please enter the correct one.",
    code_431: "failed to add, the point with the same name already exists under the substation.",
    code_432: "modification failed, the point with the same name already exists under the substation.",
    code_433: "point relation binding failed,",
    code_434: "no permission for this application, please contact the administrator to open it.",
    code_435: "the instrument manufacturer number with the same name already exists",
    code_436: "the product category of the same manufacturer already exists.",
    code_437: "the number of times to obtain the verification code of platform visitors exceeds the limit,",
    code_438: "the instrument of this substation has been bound with other equipment, please make sure the data is normal.",
    code_439: "the calculated item did not initialize the sort value,",
    code_440: "no calculation items can be changed,",
    code_441: "there are files under this document category, which cannot be deleted.",
    code_442: "the configuration of legal holidays is not available, please customize the configuration.",
    code_443: "the command could not be sent successfully, please make sure that the gateway receiver is running normally.",
    code_444: "please select an organization,",
    code_445: "the device has been bound with QR code,",
    code_446: "non platform QR code,",
    code_447: "unbound platform QR code,",
    code_448: "QR code has been bound by other devices,",
    code_449: "the interface call exceeds the limit, please try again later.",
    code_450: "the password does not conform to the specification. It must contain uppercase and lowercase letters, numbers and special symbols.",
    code_451: "too many password errors, please try again later.",
    code_452: "user or password input error,",
    code_453: "non admin user, insufficient operation authority,",
    code_454: "the person in charge of a non organization organization does not have permission to view.",
    code_455: "the organization is not equipped with a responsible person, please contact the administrator.",
    code_456: "order grabbing failed, the process of order grabbing has ended",
