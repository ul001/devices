...
function creatView(param) {
  ...
  if (param) {
    ...
    sb += '                                <div class="item-inner">';
    sb +=
      '                                    <div class="item-title" data-i18n="ui_happenTime">' +
      Operation["ui_happenTime"] +
      "</div>";
    sb +=
      '                                    <div class="item-after startTime">' +
    ...
    sb += '                                <div class="item-inner">';
    sb +=
      '                                    <div class="item-title" data-i18n="ui_alarmMeterId">' +
      Operation["ui_alarmDeviceId"] +
      "</div>";
    sb +=
      '                                    <div class="item-after meterId">' +
    ...
    sb += '                                <div class="item-inner">';
    sb +=
      '                                    <div class="item-title" data-i18n="ui_alarmMeterName">' +
      Operation["ui_alarmDeviceName"] +
      "</div>";
    sb +=
      '                                    <div class="item-after meterName">' +
    ...
    sb += '                                <div class="item-inner">';
    sb +=
      '                                    <div class="item-title" data-i18n="ui_alarmType">' +
      Operation["ui_alarmType"] +
      "</div>";
    sb +=
      '                                    <div class="item-after alarmType">' +
    ...
    if (param.hasOwnProperty("fParamcode")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_alarmParamId">' +
        Operation["ui_alarmParamId"] +
        "</div>";
      sb +=
        '                                    <div class="item-after paramId">' +
    ...
    if (param.hasOwnProperty("fParamname")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_alarmParamName">' +
        Operation["ui_alarmParamName"] +
        "</div>";
      sb +=
        '                                    <div class="item-after paramName">' +
    ...
    if (param.hasOwnProperty("valueType")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_alarmParamValueType">' +
    ...
    if (param.hasOwnProperty("fValue")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_alarmParamValue">' +
    ...
    if (param.hasOwnProperty("fLimitvalue")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_Overshootvalue">' +
    ...
    if (param.hasOwnProperty("fConfirmstatus")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_fConfirmstatus">' +
    ...
    if (param.hasOwnProperty("fConfirmusername")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_fConfirmuserid">' +
    ...
    if (param.hasOwnProperty("fConfirmtime")) {
      ...
      sb += '                                <div class="item-inner">';
      sb +=
        '                                    <div class="item-title" data-i18n="ui_fConfirmtime">' +
