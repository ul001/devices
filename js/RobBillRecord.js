                ...
                if (taskList.hasOwnProperty("list") && taskList.list.length > 0) {
                    ...
                    if (clickNum == 3) {
                        ...
                        $(taskList.list).each(function () {
                            ...
                            text +=
                                '                            <div class="card card2" id="dealMission' +
                                this.fTaskid +
                                '"  name="' +
                                this.fTaskid +
                                '" data-taskid="' +
                            ...
                            text +=
                                ...
                                "</p>";
                            // text += "<p class='row'>";
                            // text += "<span class='col-80'>" +
                            //     Operation["ui_planStarttime"] +
                            //     "：" +
                            //     this.fDeadlinedate.substring(0, 11) +
                            //     showHasCommit +
                            //     "</span>";
                            // text += "<span class='col-20'>4.9rem</span>";

                            // text += "</p>";
                            text +=
                                "<p>" +
                                Operation["ui_plandonetime"] +
                                "：" +
                                this.fDeadlinedate.substring(0, 11) +
                                showHasCommit +
                                "</p>";
